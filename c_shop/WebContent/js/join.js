 ...
 */
	...
	function id_ch(){
		window.open("join_idcheck.jsp", "id_check", "width=600, height=400px, resizable=no, scrollbars=no");
	}
	...
	function check(){
		...
		if(!(name_chk.test(join.mname.value))){
...
////		}
//		
//		if(!($("input[name='mgender']").is(":checked"))){
//			alert("성별을 선택해 주세요.");
//			return false;
//		}
