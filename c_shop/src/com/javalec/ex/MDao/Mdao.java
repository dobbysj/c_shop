...
public class Mdao {
	...
	//회원가입
	public int join(String mname, String mid, String mpw, String memail, String memail2, int mzonecode, String maddress1, String maddress2, 
			int mphone1, int mphone2, int mphone3, String mbirth, String mgender, String mnews, String msms) {
		int check =0;
		sql = "insert into c_member values(c_seq.nextval,?,?,?,?,?,?,?,?,?,?,?,to_date(?,'yy-MM-dd'),?,?,?)";
		try {
